<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link rel="stylesheet" href="/static/front/css/qna_register.css">
					...
					<tbody>
						<tr>
							...
							<td><select name="ctno" required="" fld_esssential=""
								...
								required="" fld_esssential="" label="제목" value=""></td>
						</tr>
						<tr>
							<th class="input_txt">주문번호</th>
							<td><input type="text" name="ono" style="width: 25%"
								id="onono"> <input onclick="order_open()" type="button"
						...
						<tr>
							...
							<td class="edit_area" style="position: relative;">
								...
								</div> <textarea name="content" style="width: 100%; height: 474px;"
									class="editing_area" required="" fld_esssential="" label="내용"
									id="summernote"></textarea> <input type="hidden" name="fno"
								value="1">
							</td>
						</tr>
					</tbody>
