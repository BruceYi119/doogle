...
function calendarPrint(date)
{
	if( tagNm == "INPUT" ) eventElement.value = date;
		...
		document.getElementsByName('start_date')[0].value=document.getElementsByClassName('cal-input')[0].innerText
	}
	calendarClose();
}
function calendarPrint2(date)
{
	if( tagNm == "INPUT" ) eventElement.value = date;
	else {
		eventElement.innerHTML = date;
		document.getElementsByName('end_date')[0].value=document.getElementsByClassName('cal-input')[0].innerText
	}
	calendarClose();
}
