...
public class DeliveryController {
	...
	public String deliveryList(Model model,HttpSession session) {
		...
		String firstAddr = deliveryMapper.firstAddr(mno);
		int dno = deliveryMapper.firstAddrDno(mno);
		System.out.println(dno);
		if(firstAddr.contains("서울")||firstAddr.contains("경기")||firstAddr.contains("인천"))
			deliveryMapper.firstAddrUpdate(dno);
