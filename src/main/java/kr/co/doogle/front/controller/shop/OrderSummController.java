...
public class OrderSummController {
	...
	public String orderSumm2021(Model model) 
	{
		//
		String id = "henry";
		String mno = "1";
	...
	public String orderSumm2020(Model model) 
	{
		//
		String id = "henry";
		String mno = "1";
	...
	public String orderSumm2019(Model model) 
	{
		//
		String id = "henry";
		String mno = "1";
	...
	public String orderSumm_detail(Model model, HttpServletRequest request) 
	{
		String id = "henry";
		String mno = "1";
