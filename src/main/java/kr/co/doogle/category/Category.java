...
public class Category {
...

	{
		...
		lv0.put("c", new String[]{ "현대 (무이자)", "신한", "비씨", "KB국민", "삼성", "씨티", "롯데", "하나(외환)", "NH채움", "우리", "수협", "광주", "전북", "제주", "신협체크", "MG새마을체크", "저축은행체크", "우체국카드", "KDB산업은행", "카카오뱅크" });
		lv0.put("d", new String[]{
			"현대 (무이자)", "신한 (무이자)", "비씨 (무이자)", 
			"KB국민 (무이자)", "삼성 (무이자)", "씨티 (무이자)", 
			"롯데 (무이자)", "하나(외환) (무이자)", "NH채움 (무이자)", 
			"우리 (무이자)", "수협", "광주 (무이자)", 
			"전북 (무이자)", "제주", "신협체크", "MG새마을체크", "저축은행체크", 
			"우체국카드", "KDB산업은행", "카카오뱅크"
		});
