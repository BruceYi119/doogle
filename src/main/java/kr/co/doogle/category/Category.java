...
public class Category {
...

	{
		...
		type.put("f", "파일");
		type.put("e", "에코포장");
		type.put("c", "카드(5만원 이하)");
		type.put("d", "카드(5만원 이상)");
		type.put("r", "레시피");
		...
		lv0.put("e", new String[]{ "디자인", "사이즈", "신선도", "완충성", "분리수거", "포장재제안", "기타" });
		lv0.put("c", new String[]{ "현대 (무이자) 총 12개월 | 2-7개월까지 무이자", "신한", "비씨", "KB국민", "삼성", "씨티", "롯데", "하나(외환)", "NH채움", "우리", "수협", "광주", "전북", "제주", "신협체크", "MG새마을체크", "저축은행체크", "우체국카드", "KDB산업은행", "카카오뱅크" });
		lv0.put("d", new String[]{
			"현대 (무이자) 총 12개월 | 2-7개월까지 무이자", "신한 (무이자) 총 12개월 | 2-6개월까지 무이자", "비씨 (무이자) 총 12개월 | 2-6개월까지 무이자", 
			"KB국민 (무이자) 총 12개월 | 2-6개월까지 무이자", "삼성 (무이자) 총 12개월 | 2-6개월까지 무이자", "씨티 (무이자) 총 12개월 | 2-6개월까지 무이자", 
			"롯데 (무이자) 총 12개월 | 2-4개월까지 무이자", "하나(외환) (무이자) 총 12개월 | 2-8개월까지 무이자", "NH채움 (무이자) 총 12개월 | 2-6개월까지 무이자", 
			"우리 (무이자) 총 12개월 | 2-7개월까지 무이자", "수협", "광주 (무이자) 총 12개월 | 2-5개월까지 무이자", 
			"전북 (무이자) 총 12개월 | 2-3개월까지 무이자", "제주", "신협체크", "MG새마을체크", "저축은행체크", 
			"우체국카드", "KDB산업은행", "카카오뱅크"
		});
		lv0.put("r", new String[]{ "매일밥상", "특별한날", "간단요리" });
