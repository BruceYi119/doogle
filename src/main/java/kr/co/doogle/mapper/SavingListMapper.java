...
public interface SavingListMapper {
	...
	@Insert("insert into saving_list(svlno,svno,mno,olno,credit,type) values(S_SAVING_LIST.nextval,#{mno},#{mno},0,-#{creditUsed},'m')")
	int insertCreditUsed(@Param("mno") String mno, @Param("creditUsed") String creditUsed);
}
